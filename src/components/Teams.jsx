...
const Teams = () => {
    return (
        <div className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-800 dark:text-white'>
            <Title title='Meet the team ' desc='Av passionate team of digital experts dedicated to your brands success.' />

            <div className='grid girid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5'>
